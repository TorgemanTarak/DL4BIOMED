...
## Instruction of  comet to run comet on Tabula Muris or Swissprot you will have to run the following commands:

```bash
python run.py exp.name=swissprot_pca_5shot method=comet dataset=swissprot_comet mode=train 
```
```bash
